...
<div style="border-style:solid;border-width:1px;padding:15px;margin-right: 50px;">
			<a href="reports.php"><span>التقارير</span></a> / <a href="reports_year.php?year=<?php echo $Y;?>"><span>تقارير سنة <?php echo $Y?></span></a> / <a href="reports_year_shift.php?year=<?php echo $Y;?>"><span>تقارير الشفت</span></a> / <a href="reports_year_shift_all.php?year=<?php echo $Y;?>&se_shift=<?php echo $rshift?>"><span>الشفت <?php echo $eeshift?></span></a> / <span>الدواخل</span>
			</div>
<!-- content starts -->
...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'in' AND year = '$Y' AND `shift` = '$rshift'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'in' AND year = '$Y' AND `shift` = '$rshift'");
?>
<thead>
<tr>
