...
<!-- left menu ends -->
			...
			<a href="control.php"><span>لوحة التحكم</span></a> / <span>التحكم في الحلويات</span>
			</div>
			<br/>
			<!-- content starts -->
<a href ="control_product_add.php?type=choc" class="btn btn-primary"><?php echo $lang_47;?></a>
 
<div class="row-fluid">		
				<div class="box span10">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> <?php echo $lang_111;?></h2>
...
mysql_connect("$host", "$user", "$pass")or die("cannot connect");
mysql_select_db("$db")or die("cannot select DB");
$result = mysql_query("SELECT *,SUM(stock),SUM(sold) FROM `stock` WHERE catagory = 'choc' AND name != ' '  GROUP BY name ORDER BY name ASC");
?><thead>
<tr>
  ...
  ?>    <td class="center">
																		  <span class="label label-important"><a href="control_choc.php?deleteid=<?php  echo $idid;?>"  onclick="return confirm('<?php echo $lang_244;?>')"><?php echo $lang_167;?></a></span>
									</td>      <?php 
  echo "</tr>";
  }?>
						  </tbody>
