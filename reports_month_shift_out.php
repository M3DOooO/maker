...
<div style="border-style:solid;border-width:1px;padding:15px;margin-right: 50px;">
			<a href="reports.php"><span>التقارير</span></a> / <a href="reports_month.php?month=<?php echo $M;?>&year=<?php echo $Y;?>"><span>تقارير شهر <?php echo $Y?>-<?php echo $M?></span></a> / <a href="reports_month_shift.php?month=<?php echo $M;?>&year=<?php echo $Y;?>"><span>تقارير الشفت</span></a> / <a href="reports_month_shift_all.php?month=<?php echo $M;?>&year=<?php echo $Y;?>&se_shift=<?php echo $rshift;?>"><span>الشفت <?php echo $eeshift;?> </span></a> / <span>المصاريف</span>
			</div>
<!-- content starts -->
...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'exp' AND month = '$M' AND year = '$Y' AND `shift` = '$rshift'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'exp' AND month = '$M' AND year = '$Y' AND `shift` = '$rshift'");
?><thead>
<tr>
