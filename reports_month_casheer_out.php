...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'exp' AND month = '$M' AND year = '$Y' AND `casheer` = '$Rcash'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'exp' AND month = '$M' AND year = '$Y' AND `casheer` = '$Rcash'");
?><thead>
<tr>
