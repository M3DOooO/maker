...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'exp' AND year = '$Y' AND `shift` = '$rshift'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'exp' AND year = '$Y' AND `shift` = '$rshift'");
?><thead>
<tr>
