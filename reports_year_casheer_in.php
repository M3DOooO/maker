...
<div style="border-style:solid;border-width:1px;padding:15px;margin-right: 50px;">
			<a href="reports.php"><span>التقارير</span></a> / <a href="reports_year.php?year=<?php echo $Y;?>"><span>تقارير سنة <?php echo $Y?></span></a> / <a href="reports_year_casheer.php?year=<?php echo $Y;?>"><span>تقارير الكاشير</span></a> / <a href="reports_year_casheer_all.php?year=<?php echo $Y;?>&se_cash=<?php echo $Rcash?>"><span><?php echo $Rcash?></span></a> / <span>الدواخل</span>
			</div>
<!-- content starts -->
...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'in' AND year = '$Y' AND `casheer` = '$Rcash'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'in' AND year = '$Y' AND `casheer` = '$Rcash' ");
?>
<thead>
<tr>
