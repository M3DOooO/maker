...
<!-- left menu ends -->
			...
			<a href="control.php"><span>لوحة التحكم</span></a> / <span>تصفير كل التقارير</span>
			</div>
			<br/>
...
<div class="span6 alert alert-block">
	...
	<h3><?php echo $lang_245;?> <?php echo $lang_244;?></h3><br>
	<a href="control.php"><img style="margin: 5px; float:left;" src="img/app/reports/no.png"   /></a>
	<a href = "actions/settings/reset_reports.php" ><img style="margin: 5px; float:left;" src="img/app/reports/yes.png"  /></a>
