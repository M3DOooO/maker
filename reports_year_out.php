...
<div style="border-style:solid;border-width:1px;padding:15px;margin-right: 50px;">
			<a href="reports.php"><span>التقارير</span></a> / <a href="reports_year.php?year=<?php echo $Y;?>"><span>تقارير سنة <?php echo $Y?></span></a> / <span>المصاريف</span>
			</div>
<!-- content starts -->
...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'exp' AND year = '$Y' "; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'exp' AND year = '$Y' ");
?><thead>
<tr>
...
$shift_check = $row['shift'];
 if($shift_check == 'One'){$shift_check2= $lang_155;}else{$shift_check2 = $lang_156;}
	...
	?><td class="center">
	<span class="label label-important"><a href="reports_year_out.php?year=<?php echo $Y;?>&etype=exp&&id=<?php  echo $eid;?>" ><?php echo $lang_167;?></a></span>
	</td>  <?php 
	echo "</tr>";
}?>
</tbody>
