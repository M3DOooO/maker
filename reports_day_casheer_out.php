...
<div style="border-style:solid;border-width:1px;padding:15px;margin-right: 50px;">
			<a href="reports.php"><span>التقارير</span></a> / <a href="reports_day.php?day=<?php echo $D;?>&month=<?php echo $M;?>&year=<?php echo $Y;?>"><span>تقارير يوم <?php echo $Y?>-<?php echo $M?>-<?php echo $D?></span></a> / <a href="reports_day_casheer.php?day=<?php echo $D;?>&month=<?php echo $M;?>&year=<?php echo $Y;?>"><span>تقارير الكاشير</span></a> / <a href="reports_day_casheer_all.php?day=<?php echo $D;?>&month=<?php echo $M;?>&year=<?php echo $Y;?>&se_cash=<?php echo $Rcash;?>"><span><?php echo $Rcash;?> </span></a> / <span>تقرير المصاريف</span>
			</div>
<!-- content starts -->
...
$query = "SELECT  SUM(price) FROM reports2 where catagory = 'exp' AND day = '$D' AND month = '$M' AND year = '$Y'  AND `casheer` = '$Rcash'"; 
...
$result = mysql_query("SELECT * FROM `reports2` WHERE catagory  = 'exp'  AND day = '$D' AND month = '$M' AND year = '$Y'  AND `casheer` = '$Rcash'");
?><thead>
<tr>
